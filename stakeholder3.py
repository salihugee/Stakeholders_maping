...
try:
    ...
    logging.error(f"Error loading boundaries: {e}")
...
search_script = f"""
<script>
    var map = {m.get_name()};  // Use the correct map instance name
...
# Save the Map
m.save("stakeholders_map3.html")
logging.info("✅ Map has been generated successfully! Open 'stakeholders_map.html' to view it.")
